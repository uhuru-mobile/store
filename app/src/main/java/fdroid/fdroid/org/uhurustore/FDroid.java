...
import fdroid.fdroid.org.uhurustore.views.AppListFragmentPageAdapter;
...
public class FDroid extends FragmentActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case ABOUT:
            ...
            Builder p = new Builder(this).setView(view);
            ...
            new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog,
                                    int whichButton) {
                    Uri uri = Uri.parse("https://www.uhuru-mobile.com");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_MANAGEREPOS:
            if (data.hasExtra("update")) {
                ...
                ask_alrt.setIcon(drawable.ic_menu_rotate);
    ...
    public void updateRepos() {
        ...
        pd.setIcon(drawable.ic_dialog_info);
